...
include("../include/menulateralclien.php")
  ...
  <div class="panel-heading">Aprobado</div>
...
inner join problema as pro on pro.idproblema=tic.problema_idproblema where  tic.persona_idpersona='$valor' and idempleado >0  ") ;
