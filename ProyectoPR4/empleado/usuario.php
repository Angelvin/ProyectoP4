...
$result= mysql_query("select  p.idpersona,p.nombre,p.Snombre, p.apellido, p.Sapellido, p.telefono from persona as p inner join login as l on p.login_idlogin=l.idlogin inner join rol as r on l.rol_idrol=r.idrol where r.idrol=1");
...
<tr>
 ...
 <td><form  id="updateCita" method="post" action="updateusuario.php ">
